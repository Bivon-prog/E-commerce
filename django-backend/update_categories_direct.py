#!/usr/bin/env python
"""
Update products directly in Astra database with comprehensive categories
"""
import os
import sys
...
def main():
    print("=" * 80)
    print("  UPDATING PRODUCTS WITH COMPREHENSIVE CATEGORIES")
    print("=" * 80)
    ...
    try:
        ...
        for i, product in enumerate(products, 1):
            ...
            try:
                success = AstraProduct.update(product['_id'], product)
                if success:
                    success_count += 1
